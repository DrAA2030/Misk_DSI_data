...
source("in-class/2 - Data handling_rick.R")
...
# == # relational operator - test of equivalency
# != # relational operator - test of non=equivalency
# <- # assign operator
# <= # relational operator - test of less of equal value
# -> # reverse assign operator
# =  # assign value to arg in a func (but can also be used as the assign operator)

# As an aside:
# access a function in a package without 
# attaching the entire package
# medi <- rio::import("data/Expression.txt")
