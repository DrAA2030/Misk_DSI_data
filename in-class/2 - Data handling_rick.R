...
# log is the function, x & base are 
# arguments 8 & 2 values assigned to the arguments
log(x = 8, base = 2) # long form, named args
log2(8) # short form, positional matching
log(8, 2) # long form, positional matching
log(base = 2, 8) # long form, CONFUSING!
log(8, base = 10/5) # long form, more complex than necessary
log10(10000)
